  ...
  return(
    <section className="register">
      ...
      <form className="form" id="form-register">
        ...
        <input className="form__input" type="email" name="email" pattern='^.+@.+\..+$' placeholder="E-mail" required minLength="2" maxLength="20" onChange={handleFormChange} value={formValues.email || ''} />
